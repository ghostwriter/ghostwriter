...
| State | Description |
| --- | --- |
| (TAGGED) | Release [0.10.20](https://github.com/carlosas/phpat/releases/tag/0.10.20) on [carlosas/phpat](https://github.com/carlosas/phpat) (4 weeks ago)|
| (TAGGED) | Release [v7.3.0](https://github.com/MyIntervals/emogrifier/releases/tag/v7.3.0) on [MyIntervals/emogrifier](https://github.com/MyIntervals/emogrifier) (1 month ago)|
| (TAGGED) | Release [v8.7.0](https://github.com/MyIntervals/PHP-CSS-Parser/releases/tag/v8.7.0) on [MyIntervals/PHP-CSS-Parser](https://github.com/MyIntervals/PHP-CSS-Parser) (1 month ago)|
| (TAGGED) | Release [0.1.3](https://github.com/ghostwriter/handrail/releases/tag/0.1.3) on [ghostwriter/handrail](https://github.com/ghostwriter/handrail) (2 months ago)|
| (TAGGED) | Release [0.1.0](https://github.com/ghostwriter/testify/releases/tag/0.1.0) on [ghostwriter/testify](https://github.com/ghostwriter/testify) (2 months ago)|
| (TAGGED) | Release [0.1.1](https://github.com/ghostwriter/filesystem/releases/tag/0.1.1) on [ghostwriter/filesystem](https://github.com/ghostwriter/filesystem) (2 months ago)|
...
| ⭐️ (10652) [`mockery/mockery`](https://github.com/mockery/mockery) | Mockery is a simple yet flexible PHP mock object framework for use in unit testing with PHPUnit, PHPSpec or any other testing framework. Its core goal is to offer a test double framework with a succinct API capable of clearly defining all possible object operations and interactions using a human readable Domain Specific Language (DSL). |
...
| ⭐️ (0) [`ghostwriter/revamp`](https://github.com/ghostwriter/revamp) | [WIP] Upgrade rules for PHP frameworks, libraries, and tools. |
| ⭐️ (0) [`ghostwriter/phormat`](https://github.com/ghostwriter/phormat) | [WIP] PHP code formatter. |
...
| ⭐️ (17098) [`nikic/PHP-Parser`](https://github.com/nikic/PHP-Parser) | A PHP parser written in PHP |
...
| ⭐️ (0) [`ghostwriter/git`](https://github.com/ghostwriter/git) | [WIP]Git wrapper written in PHP |
...
| ⭐️ (1771) [`MyIntervals/PHP-CSS-Parser`](https://github.com/MyIntervals/PHP-CSS-Parser) | A Parser for CSS Files written in PHP. Allows extraction of CSS files into a data structure, manipulation of said structure and output as (optimized) CSS |
| ⭐️ (914) [`MyIntervals/emogrifier`](https://github.com/MyIntervals/emogrifier) | Converts CSS styles into inline style attributes in your HTML code. |
| ⭐️ (1100) [`carlosas/phpat`](https://github.com/carlosas/phpat) | PHP Architecture Tester - Easy architecture testing for PHP :heavy_check_mark: |
| ⭐️ (0) [`ghostwriter/gfm`](https://github.com/ghostwriter/gfm) | [WIP] GitHub Flavored Markdown parser and generator for PHP |
| ⭐️ (0) [`ghostwriter/type`](https://github.com/ghostwriter/type) | Attribute, DocBlock, and Reflection-Based Type Utilities for PHP: Inspect, Validate, and Convert values. |
| ⭐️ (0) [`ghostwriter/plex`](https://github.com/ghostwriter/plex) | Provides the fastest lexer for PHP, tokenizing text with named regex patterns for efficient processing. |
...
| ⭐️ (0) [`ghostwriter/flare`](https://github.com/ghostwriter/flare) | [WIP]Provides additional assertions, constraints, and data providers for PHPUnit |
| ⭐️ (0) [`ghostwriter/abnf`](https://github.com/ghostwriter/abnf) | [WIP]Augmented Backus-Naur Form parser for PHP, as described in RFC5234 and RFC7405 |
