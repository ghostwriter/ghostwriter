...
| State | Description |
| --- | --- |
| (MERGED) | [Refactor API and Cleanup Generics](https://github.com/ghostwriter/result/pull/21) on [ghostwriter/result](https://github.com/ghostwriter/result) (today)|
| (MERGED) | [Bump `friendsofphp/php-cs-fixer` from `3.20.0` to `3.21.1`](https://github.com/ghostwriter/coding-standard/pull/74) on [ghostwriter/coding-standard](https://github.com/ghostwriter/coding-standard) (1 day ago)|
| (MERGED) | [Bump `ghostwriter/option` from `1.5.0` to `1.5.1`](https://github.com/ghostwriter/result/pull/20) on [ghostwriter/result](https://github.com/ghostwriter/result) (1 day ago)|
| (MERGED) | [`None` should return `never` not `null`](https://github.com/ghostwriter/option/pull/42) on [ghostwriter/option](https://github.com/ghostwriter/option) (1 day ago)|
| (MERGED) | [Lock file maintenance](https://github.com/ghostwriter/coding-standard/pull/73) on [ghostwriter/coding-standard](https://github.com/ghostwriter/coding-standard) (6 days ago)|
...
| (MERGED) | [Update codecov workflow](https://github.com/mockery/mockery/pull/1288) on [mockery/mockery](https://github.com/mockery/mockery) (1 week ago)|
| (MERGED) | [Update psalm configuration and workflow](https://github.com/mockery/mockery/pull/1287) on [mockery/mockery](https://github.com/mockery/mockery) (1 week ago)|
| (MERGED) | [Update phpunit workflow](https://github.com/mockery/mockery/pull/1286) on [mockery/mockery](https://github.com/mockery/mockery) (1 week ago)|
| (MERGED) | [Update compliance.yml](https://github.com/ghostwriter/container/pull/27) on [ghostwriter/container](https://github.com/ghostwriter/container) (1 week ago)|
| (MERGED) | [Lock file maintenance](https://github.com/ghostwriter/coding-standard/pull/71) on [ghostwriter/coding-standard](https://github.com/ghostwriter/coding-standard) (1 week ago)|
| (OPEN) | [Support empty collections in `_embedded` section](https://github.com/mezzio/mezzio-hal/pull/80) on [mezzio/mezzio-hal](https://github.com/mezzio/mezzio-hal) (1 week ago)|
| (MERGED) | [Enforce the minimum required PHP version](https://github.com/mockery/mockery/pull/1285) on [mockery/mockery](https://github.com/mockery/mockery) (1 week ago)|
...
| (MERGED) | [[PHP 8.2]Bump PHP-FPM from 8.2.6 to 8.2.7](https://github.com/ghostwriter/php/pull/348) on [ghostwriter/php](https://github.com/ghostwriter/php) (4 weeks ago)|
| (MERGED) | [[PHP 8.2]Bump PHP-CLI from 8.2.6 to 8.2.7](https://github.com/ghostwriter/php/pull/347) on [ghostwriter/php](https://github.com/ghostwriter/php) (4 weeks ago)|
| (MERGED) | [[PHP 8.1]Bump PHP-FPM from 8.1.19 to 8.1.20](https://github.com/ghostwriter/php/pull/346) on [ghostwriter/php](https://github.com/ghostwriter/php) (4 weeks ago)|
| (MERGED) | [[PHP 8.1]Bump PHP-CLI from 8.1.19 to 8.1.20](https://github.com/ghostwriter/php/pull/345) on [ghostwriter/php](https://github.com/ghostwriter/php) (4 weeks ago)|
| (TAGGED) | Release [1.3.0](https://github.com/ghostwriter/result/releases/tag/1.3.0) on [ghostwriter/result](https://github.com/ghostwriter/result) (today)|
| (TAGGED) | Release [1.5.1](https://github.com/ghostwriter/option/releases/tag/1.5.1) on [ghostwriter/option](https://github.com/ghostwriter/option) (1 day ago)|
...
| (TAGGED) | Release [4.7.0](https://github.com/mezzio/mezzio-swoole/releases/tag/4.7.0) on [mezzio/mezzio-swoole](https://github.com/mezzio/mezzio-swoole) (3 weeks ago)|
| (TAGGED) | Release [1.6.2](https://github.com/mockery/mockery/releases/tag/1.6.2) on [mockery/mockery](https://github.com/mockery/mockery) (4 weeks ago)|
...
| ⭐️ (10427) [`mockery/mockery`](https://github.com/mockery/mockery) | Mockery is a simple yet flexible PHP mock object framework for use in unit testing with PHPUnit, PHPSpec or any other testing framework. Its core goal is to offer a test double framework with a succinct API capable of clearly defining all possible object operations and interactions using a human readable Domain Specific Language (DSL). |
...
| ⭐️ (1553) [`php-fig/http-factory`](https://github.com/php-fig/http-factory) | Implementation of PSR-17 (HTTP Message Factories) |
...
| ⭐️ (1432) [`php-fig/http-client`](https://github.com/php-fig/http-client) |  |
