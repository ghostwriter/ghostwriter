...
| State | Description |
| --- | --- |
| (TAGGED) | Release [0.1.3](https://github.com/ghostwriter/git/releases/tag/0.1.3) on [ghostwriter/git](https://github.com/ghostwriter/git) (3 days ago)|
| (TAGGED) | Release [0.1.4](https://github.com/ghostwriter/shell/releases/tag/0.1.4) on [ghostwriter/shell](https://github.com/ghostwriter/shell) (4 days ago)|
| (TAGGED) | Release [0.1.0](https://github.com/ghostwriter/github-cli/releases/tag/0.1.0) on [ghostwriter/github-cli](https://github.com/ghostwriter/github-cli) (4 weeks ago)|
| (TAGGED) | Release [2.0.2](https://github.com/ghostwriter/config/releases/tag/2.0.2) on [ghostwriter/config](https://github.com/ghostwriter/config) (1 month ago)|
| (TAGGED) | Release [0.1.2](https://github.com/ghostwriter/console/releases/tag/0.1.2) on [ghostwriter/console](https://github.com/ghostwriter/console) (2 months ago)|
| (TAGGED) | Release [3.0.1](https://github.com/ghostwriter/json/releases/tag/3.0.1) on [ghostwriter/json](https://github.com/ghostwriter/json) (2 months ago)|
...
| ⭐️ (1) [`ghostwriter/container`](https://github.com/ghostwriter/container) | Provides an extensible Dependency Injection Service Container for Automated Object Composition, Interception, and Lifetime Management. |
...
| ⭐️ (2) [`ghostwriter/wip`](https://github.com/ghostwriter/wip) | [WIP] Template for PHP projects |
| ⭐️ (1) [`ghostwriter/event-dispatcher`](https://github.com/ghostwriter/event-dispatcher) | Event Dispatcher implementation. |
...
| ⭐️ (0) [`ghostwriter/craft`](https://github.com/ghostwriter/craft) | [WIP] Generate a PHP Web Applications from draft.php files |
...
| ⭐️ (10734) [`mockery/mockery`](https://github.com/mockery/mockery) | Mockery is a simple yet flexible PHP mock object framework for use in unit testing with PHPUnit, PHPSpec or any other testing framework. Its core goal is to offer a test double framework with a succinct API capable of clearly defining all possible object operations and interactions using a human readable Domain Specific Language (DSL). |
| ⭐️ (0) [`ghostwriter/git`](https://github.com/ghostwriter/git) | PHP wrapper for Git commands. |
| ⭐️ (0) [`ghostwriter/cron`](https://github.com/ghostwriter/cron) | [WIP] Nanosecond-accurate cron scheduling engine implementation in PHP |
...
| ⭐️ (0) [`mezzio-modules/template`](https://github.com/mezzio-modules/template) | [WIP] Template repository for Mezzio modules |
| ⭐️ (0) [`ghostwriter/empty-vs-strict-benchmark`](https://github.com/ghostwriter/empty-vs-strict-benchmark) | [WIP] Benchmarking empty vs strict comparisons in PHP |
| ⭐️ (0) [`ghostwriter/parser`](https://github.com/ghostwriter/parser) | [WIP] PHP Parser implementation in PHP |
