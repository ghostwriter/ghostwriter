...
- [laminas/laminas-diagnostics](https://github.com/laminas/laminas-diagnostics) ([1.10.0](https://github.com/laminas/laminas-diagnostics/releases/tag/1.10.0), 1 day ago) - A set of components for performing diagnostic tests in PHP applications
...
- [nette/php-generator](https://github.com/nette/php-generator) ([v3.5.4](https://github.com/nette/php-generator/releases/tag/v3.5.4), 6 days ago) - 🐘 Generates neat PHP code for you. Supports new PHP 8.0 features.
...
- [laminas/laminas-form](https://github.com/laminas/laminas-form) ([3.0.1](https://github.com/laminas/laminas-form/releases/tag/3.0.1), 2 weeks ago) - Validate and display simple and complex forms, casting forms to business objects and vice versa
