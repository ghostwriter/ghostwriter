...
- [laminas/laminas-code](https://github.com/laminas/laminas-code) ([4.4.0](https://github.com/laminas/laminas-code/releases/tag/4.4.0), 3 weeks ago) - Extensions to the PHP Reflection API, static code scanning, and code generation
