...
| State | Description |
| --- | --- |
| (TAGGED) | Release [v5.5.0](https://github.com/nikic/PHP-Parser/releases/tag/v5.5.0) on [nikic/PHP-Parser](https://github.com/nikic/PHP-Parser) (2 weeks ago)|
| (TAGGED) | Release [0.11.5](https://github.com/carlosas/phpat/releases/tag/0.11.5) on [carlosas/phpat](https://github.com/carlosas/phpat) (2 weeks ago)|
...
| ⭐️ (10699) [`mockery/mockery`](https://github.com/mockery/mockery) | Mockery is a simple yet flexible PHP mock object framework for use in unit testing with PHPUnit, PHPSpec or any other testing framework. Its core goal is to offer a test double framework with a succinct API capable of clearly defining all possible object operations and interactions using a human readable Domain Specific Language (DSL). |
