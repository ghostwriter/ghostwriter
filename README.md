...
- [laminas/laminas-diagnostics](https://github.com/laminas/laminas-diagnostics) ([1.10.0](https://github.com/laminas/laminas-diagnostics/releases/tag/1.10.0), today) - A set of components for performing diagnostic tests in PHP applications
...
- [nette/php-generator](https://github.com/nette/php-generator) ([v3.5.4](https://github.com/nette/php-generator/releases/tag/v3.5.4), 5 days ago) - 🐘 Generates neat PHP code for you. Supports new PHP 8.0 features.
