...
| State | Description |
| --- | --- |
| (TAGGED) | Release [5.0.3](https://github.com/ghostwriter/event-dispatcher/releases/tag/5.0.3) on [ghostwriter/event-dispatcher](https://github.com/ghostwriter/event-dispatcher) (1 day ago)|
| (TAGGED) | Release [5.0.0](https://github.com/ghostwriter/container/releases/tag/5.0.0) on [ghostwriter/container](https://github.com/ghostwriter/container) (1 day ago)|
| (TAGGED) | Release [0.11.3](https://github.com/carlosas/phpat/releases/tag/0.11.3) on [carlosas/phpat](https://github.com/carlosas/phpat) (1 week ago)|
...
| ⭐️ (17171) [`nikic/PHP-Parser`](https://github.com/nikic/PHP-Parser) | A PHP parser written in PHP |
