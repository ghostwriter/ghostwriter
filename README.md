...
| State | Description |
| --- | --- |
| (TAGGED) | Release [v5.6.2](https://github.com/nikic/PHP-Parser/releases/tag/v5.6.2) on [nikic/PHP-Parser](https://github.com/nikic/PHP-Parser) (5 days ago)|
| (TAGGED) | Release [0.1.5](https://github.com/ghostwriter/handrail/releases/tag/0.1.5) on [ghostwriter/handrail](https://github.com/ghostwriter/handrail) (1 week ago)|
...
| (TAGGED) | Release [5.0.3](https://github.com/ghostwriter/event-dispatcher/releases/tag/5.0.3) on [ghostwriter/event-dispatcher](https://github.com/ghostwriter/event-dispatcher) (8 months ago)|
