...
| State | Description |
| --- | --- |
| (TAGGED) | Release [6.0.1](https://github.com/ghostwriter/event-dispatcher/releases/tag/6.0.1) on [ghostwriter/event-dispatcher](https://github.com/ghostwriter/event-dispatcher) (today)|
| (TAGGED) | Release [0.1.2](https://github.com/ghostwriter/filesystem/releases/tag/0.1.2) on [ghostwriter/filesystem](https://github.com/ghostwriter/filesystem) (2 days ago)|
| (TAGGED) | Release [0.1.0](https://github.com/ghostwriter/console/releases/tag/0.1.0) on [ghostwriter/console](https://github.com/ghostwriter/console) (3 days ago)|
| (TAGGED) | Release [2.0.1](https://github.com/ghostwriter/config/releases/tag/2.0.1) on [ghostwriter/config](https://github.com/ghostwriter/config) (4 days ago)|
| (TAGGED) | Release [6.0.1](https://github.com/ghostwriter/container/releases/tag/6.0.1) on [ghostwriter/container](https://github.com/ghostwriter/container) (5 days ago)|
| (TAGGED) | Release [2.14.0](https://github.com/mezzio/mezzio-platesrenderer/releases/tag/2.14.0) on [mezzio/mezzio-platesrenderer](https://github.com/mezzio/mezzio-platesrenderer) (1 week ago)|
...
| ⭐️ (4) [`mezzio/mezzio-platesrenderer`](https://github.com/mezzio/mezzio-platesrenderer) | Plates integration for Mezzio |
