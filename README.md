...
| (TAGGED) | Release [5.0.3](https://github.com/ghostwriter/event-dispatcher/releases/tag/5.0.3) on [ghostwriter/event-dispatcher](https://github.com/ghostwriter/event-dispatcher) (2 weeks ago)|
| (TAGGED) | Release [5.0.0](https://github.com/ghostwriter/container/releases/tag/5.0.0) on [ghostwriter/container](https://github.com/ghostwriter/container) (2 weeks ago)|
...
| (TAGGED) | Release [2.0.0](https://github.com/ghostwriter/option/releases/tag/2.0.0) on [ghostwriter/option](https://github.com/ghostwriter/option) (1 month ago)|
...
| ⭐️ (112) [`rectorphp/rector-src`](https://github.com/rectorphp/rector-src) | Development repository for Rector |
| ⭐️ (17186) [`nikic/PHP-Parser`](https://github.com/nikic/PHP-Parser) | A PHP parser written in PHP |
...
| ⭐️ (1145) [`carlosas/phpat`](https://github.com/carlosas/phpat) | ✔️ PHP Architecture Tester - Easy architecture testing for PHP  |
