...
- [ajthinking/archetype](https://github.com/ajthinking/archetype) ([v0.2.5](https://github.com/ajthinking/archetype/releases/tag/v0.2.5), 4 days ago) - A Rapid Application Devlopment framework for PHP and Laravel
- [laminas/laminas-validator](https://github.com/laminas/laminas-validator) ([2.14.5](https://github.com/laminas/laminas-validator/releases/tag/2.14.5), 6 days ago) - Validation classes for a wide range of domains, and the ability to chain validators to create complex validation criteria
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v6.23.1](https://github.com/orchestral/testbench-core/releases/tag/v6.23.1), 6 days ago) - Testing Helper for Laravel Development
...
- [laminas/laminas-escaper](https://github.com/laminas/laminas-escaper) ([2.8.0](https://github.com/laminas/laminas-escaper/releases/tag/2.8.0), 3 weeks ago) - Securely and safely escape HTML, HTML attributes, JavaScript, CSS, and URLs
