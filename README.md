...
| State | Description |
| --- | --- |
| (TAGGED) | Release [v5.5.0](https://github.com/nikic/PHP-Parser/releases/tag/v5.5.0) on [nikic/PHP-Parser](https://github.com/nikic/PHP-Parser) (1 day ago)|
| (TAGGED) | Release [0.11.5](https://github.com/carlosas/phpat/releases/tag/0.11.5) on [carlosas/phpat](https://github.com/carlosas/phpat) (4 days ago)|
...
| ⭐️ (0) [`ghostwriter/nixify`](https://github.com/ghostwriter/nixify) | Automated Nix flake and development environment generator for PHP projects. |
...
| ⭐️ (10697) [`mockery/mockery`](https://github.com/mockery/mockery) | Mockery is a simple yet flexible PHP mock object framework for use in unit testing with PHPUnit, PHPSpec or any other testing framework. Its core goal is to offer a test double framework with a succinct API capable of clearly defining all possible object operations and interactions using a human readable Domain Specific Language (DSL). |
| ⭐️ (116) [`rectorphp/rector-src`](https://github.com/rectorphp/rector-src) | Development repository for Rector |
| ⭐️ (17252) [`nikic/PHP-Parser`](https://github.com/nikic/PHP-Parser) | A PHP parser written in PHP |
| ⭐️ (933) [`MyIntervals/emogrifier`](https://github.com/MyIntervals/emogrifier) | Converts CSS styles into inline style attributes in your HTML code. |
