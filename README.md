...
- [Bump `symplify/easy-coding-standard` to `^11.0.3`](https://github.com/ghostwriter/option/pull/3) on [ghostwriter/option](https://github.com/ghostwriter/option) (1 day ago)
- [Bump `roave/infection-static-analysis-plugin` to `^1.20.0`](https://github.com/ghostwriter/option/pull/2) on [ghostwriter/option](https://github.com/ghostwriter/option) (1 day ago)
- [Feature: Add compliance](https://github.com/ghostwriter/draft/pull/1) on [ghostwriter/draft](https://github.com/ghostwriter/draft) (1 day ago)
- [Bump `PHP` to `8.1.7`](https://github.com/ghostwriter/php/pull/65) on [ghostwriter/php](https://github.com/ghostwriter/php) (3 days ago)
- [Bump `PHP` to `8.0.20`](https://github.com/ghostwriter/php/pull/64) on [ghostwriter/php](https://github.com/ghostwriter/php) (3 days ago)
- [Bump `PHP` to `7.4.30`](https://github.com/ghostwriter/php/pull/63) on [ghostwriter/php](https://github.com/ghostwriter/php) (3 days ago)
