...
#### ✊🏿🖤✊🏻 `#BlackLivesMatter` | 🇵🇸 `#FreePalestine` | 🇮🇷 `#StandWithIran` | 🇺🇦 `#StandWithUkraine`

<img alt="Created by a Human, not by AI" src="./templates/badge.svg"> Hand-crafted artisanal software, the old fashioned way.
...
| State | Description |
| --- | --- |
| (TAGGED) | Release [0.2.1](https://github.com/ghostwriter/http/releases/tag/0.2.1) on [ghostwriter/http](https://github.com/ghostwriter/http) (5 days ago)|
| (TAGGED) | Release [0.1.6](https://github.com/ghostwriter/shell/releases/tag/0.1.6) on [ghostwriter/shell](https://github.com/ghostwriter/shell) (1 week ago)|
| (TAGGED) | Release [2.1.1](https://github.com/ghostwriter/collection/releases/tag/2.1.1) on [ghostwriter/collection](https://github.com/ghostwriter/collection) (1 week ago)|
| (TAGGED) | Release [0.2.1](https://github.com/ghostwriter/filesystem/releases/tag/0.2.1) on [ghostwriter/filesystem](https://github.com/ghostwriter/filesystem) (1 week ago)|
| (TAGGED) | Release [3.0.3](https://github.com/ghostwriter/json/releases/tag/3.0.3) on [ghostwriter/json](https://github.com/ghostwriter/json) (1 week ago)|
...
| ⭐️ (0) [`ghostwriter/advent-of-code`](https://github.com/ghostwriter/advent-of-code) | Advent of Code |
...
| ⭐️ (0) [`ghostwriter/validator`](https://github.com/ghostwriter/validator) | [WIP] Stateless Validation Execution Engine with Immutable Rule Objects |
...
| ⭐️ (2) [`ghostwriter/event-dispatcher`](https://github.com/ghostwriter/event-dispatcher) | Event Dispatcher implementation. |
| ⭐️ (0) [`ghostwriter/redaction`](https://github.com/ghostwriter/redaction) | [WIP] Redaction library for PHP |
