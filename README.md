...
| State | Description |
| --- | --- |
| (TAGGED) | Release [2.0.2](https://github.com/ghostwriter/config/releases/tag/2.0.2) on [ghostwriter/config](https://github.com/ghostwriter/config) (2 weeks ago)|
...
| (TAGGED) | Release [6.0.2](https://github.com/ghostwriter/event-dispatcher/releases/tag/6.0.2) on [ghostwriter/event-dispatcher](https://github.com/ghostwriter/event-dispatcher) (1 month ago)|
