...
| State | Description |
| --- | --- |
| (TAGGED) | Release [0.11.9](https://github.com/carlosas/phpat/releases/tag/0.11.9) on [carlosas/phpat](https://github.com/carlosas/phpat) (1 week ago)|
| (TAGGED) | Release [v5.6.0](https://github.com/nikic/PHP-Parser/releases/tag/v5.6.0) on [nikic/PHP-Parser](https://github.com/nikic/PHP-Parser) (1 week ago)|
| (TAGGED) | Release [v8.0.0](https://github.com/MyIntervals/emogrifier/releases/tag/v8.0.0) on [MyIntervals/emogrifier](https://github.com/MyIntervals/emogrifier) (1 week ago)|
| (TAGGED) | Release [v9.0.0](https://github.com/MyIntervals/PHP-CSS-Parser/releases/tag/v9.0.0) on [MyIntervals/PHP-CSS-Parser](https://github.com/MyIntervals/PHP-CSS-Parser) (1 week ago)|
...
| ⭐️ (2) [`ghostwriter/template`](https://github.com/ghostwriter/template) | [WIP] Template for PHP projects |
...
| ⭐️ (0) [`ghostwriter/changelog`](https://github.com/ghostwriter/changelog) | [WIP] Effortlessly manage project changelogs with GitHub Milestones, Issue Labels, and PR Labels, aligned with the &#39;Keep a Changelog&#39; standard, powered by GitHub CLI |
...
| ⭐️ (0) [`nix-php/template`](https://github.com/nix-php/template) | [WIP] Nix flake exposing the `template` PHP CLI application |
| ⭐️ (0) [`ghostwriter/graphql`](https://github.com/ghostwriter/graphql) | [WIP] GraphQL implementation for PHP |
