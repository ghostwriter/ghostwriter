...
| State | Description |
| --- | --- |
| (TAGGED) | Release [6.0.0](https://github.com/ghostwriter/event-dispatcher/releases/tag/6.0.0) on [ghostwriter/event-dispatcher](https://github.com/ghostwriter/event-dispatcher) (today)|
| (TAGGED) | Release [0.1.0](https://github.com/ghostwriter/console/releases/tag/0.1.0) on [ghostwriter/console](https://github.com/ghostwriter/console) (today)|
| (TAGGED) | Release [2.0.1](https://github.com/ghostwriter/config/releases/tag/2.0.1) on [ghostwriter/config](https://github.com/ghostwriter/config) (1 day ago)|
| (TAGGED) | Release [6.0.1](https://github.com/ghostwriter/container/releases/tag/6.0.1) on [ghostwriter/container](https://github.com/ghostwriter/container) (2 days ago)|
| (TAGGED) | Release [2.14.0](https://github.com/mezzio/mezzio-platesrenderer/releases/tag/2.14.0) on [mezzio/mezzio-platesrenderer](https://github.com/mezzio/mezzio-platesrenderer) (4 days ago)|
| (TAGGED) | Release [v5.6.2](https://github.com/nikic/PHP-Parser/releases/tag/v5.6.2) on [nikic/PHP-Parser](https://github.com/nikic/PHP-Parser) (1 month ago)|
