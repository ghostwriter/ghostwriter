...
| State | Description |
| --- | --- |
| (TAGGED) | Release [2.0.6](https://github.com/mnapoli/FrontYAML/releases/tag/2.0.6) on [mnapoli/FrontYAML](https://github.com/mnapoli/FrontYAML) (1 day ago)|
| (TAGGED) | Release [v1.8.6](https://github.com/tighten/jigsaw/releases/tag/v1.8.6) on [tighten/jigsaw](https://github.com/tighten/jigsaw) (6 days ago)|
| (TAGGED) | Release [0.1.0](https://github.com/nix-php/nixify/releases/tag/0.1.0) on [nix-php/nixify](https://github.com/nix-php/nixify) (1 week ago)|
| (TAGGED) | Release [0.1.0](https://github.com/ghostwriter/http/releases/tag/0.1.0) on [ghostwriter/http](https://github.com/ghostwriter/http) (1 month ago)|
| (TAGGED) | Release [0.1.3](https://github.com/ghostwriter/console/releases/tag/0.1.3) on [ghostwriter/console](https://github.com/ghostwriter/console) (1 month ago)|
