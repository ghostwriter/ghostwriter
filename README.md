...
| State | Description |
| --- | --- |
| (TAGGED) | Release [11.0.6](https://github.com/sebastianbergmann/phpunit/releases/tag/11.0.6) on [sebastianbergmann/phpunit](https://github.com/sebastianbergmann/phpunit) (6 days ago)|
| (TAGGED) | Release [1.6.9](https://github.com/mockery/mockery/releases/tag/1.6.9) on [mockery/mockery](https://github.com/mockery/mockery) (6 days ago)|
| (TAGGED) | Release [2.0.0](https://github.com/ghostwriter/collection/releases/tag/2.0.0) on [ghostwriter/collection](https://github.com/ghostwriter/collection) (3 weeks ago)|
| (TAGGED) | Release [3.0.2](https://github.com/ghostwriter/container/releases/tag/3.0.2) on [ghostwriter/container](https://github.com/ghostwriter/container) (4 weeks ago)|
| (TAGGED) | Release [1.0.0](https://github.com/ghostwriter/case-converter/releases/tag/1.0.0) on [ghostwriter/case-converter](https://github.com/ghostwriter/case-converter) (1 month ago)|
| (TAGGED) | Release [3.0.0](https://github.com/ghostwriter/json/releases/tag/3.0.0) on [ghostwriter/json](https://github.com/ghostwriter/json) (1 month ago)|
...
| ⭐️ (10545) [`mockery/mockery`](https://github.com/mockery/mockery) | Mockery is a simple yet flexible PHP mock object framework for use in unit testing with PHPUnit, PHPSpec or any other testing framework. Its core goal is to offer a test double framework with a succinct API capable of clearly defining all possible object operations and interactions using a human readable Domain Specific Language (DSL). |
...
| ⭐️ (0) [`ghostwriter/mockery-rector`](https://github.com/ghostwriter/mockery-rector) | Rector upgrades rules for Mockery |
...
| ⭐️ (2297) [`php/php-langspec`](https://github.com/php/php-langspec) | PHP Language Specification |
| ⭐️ (0) [`ghostwriter/event-loop`](https://github.com/ghostwriter/event-loop) | A high-performance event-loop library designed for concurrent PHP applications, enabling efficient handling of asynchronous operations and event-driven programming paradigms. |
...
| ⭐️ (19538) [`sebastianbergmann/phpunit`](https://github.com/sebastianbergmann/phpunit) | The PHP Unit Testing framework. |
...
| ⭐️ (56) [`rectorphp/rector-phpunit`](https://github.com/rectorphp/rector-phpunit) | Rector upgrade rules for PHPUnit |
...
| ⭐️ (1556) [`php-fig/http-client`](https://github.com/php-fig/http-client) |  |
| ⭐️ (1677) [`php-fig/http-factory`](https://github.com/php-fig/http-factory) | Implementation of PSR-17 (HTTP Message Factories) |
| ⭐️ (164) [`php-fig/http-server-handler`](https://github.com/php-fig/http-server-handler) | Interface for PSR-15 server request handler |
