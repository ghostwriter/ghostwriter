...
- [Add multi-platform build](https://github.com/ghostwriter/php/pull/12) on [ghostwriter/php](https://github.com/ghostwriter/php) (2 days ago)
- [Update docker build and push workflow](https://github.com/ghostwriter/php/pull/11) on [ghostwriter/php](https://github.com/ghostwriter/php) (2 days ago)
...
- [ghostwriter/composer-lock](https://github.com/ghostwriter/composer-lock) ([0.1.1](https://github.com/ghostwriter/composer-lock/releases/tag/0.1.1), 2 days ago) - Bumps composer.lock file, optionally lock the minimum supported PHP version
- [laminas/laminas-escaper](https://github.com/laminas/laminas-escaper) ([2.10.0](https://github.com/laminas/laminas-escaper/releases/tag/2.10.0), 3 days ago) - Securely and safely escape HTML, HTML attributes, JavaScript, CSS, and URLs
- [laminas/laminas-validator](https://github.com/laminas/laminas-validator) ([2.17.0](https://github.com/laminas/laminas-validator/releases/tag/2.17.0), 3 days ago) - Validation classes for a wide range of domains, and the ability to chain validators to create complex validation criteria
- [laminas/laminas-servicemanager-migration](https://github.com/laminas/laminas-servicemanager-migration) ([0.3.0](https://github.com/laminas/laminas-servicemanager-migration/releases/tag/0.3.0), 5 days ago) - Migrate your code to laminas-servicemanager 4.x compatibility utilizing Rector rules.
...
- [laminas/laminas-cache-storage-adapter-memory](https://github.com/laminas/laminas-cache-storage-adapter-memory) -  (6 days ago)
