...
| State | Description |
| --- | --- |
| (TAGGED) | Release [v8.8.0](https://github.com/MyIntervals/PHP-CSS-Parser/releases/tag/v8.8.0) on [MyIntervals/PHP-CSS-Parser](https://github.com/MyIntervals/PHP-CSS-Parser) (1 month ago)|
| (TAGGED) | Release [2.1.0](https://github.com/ghostwriter/case-converter/releases/tag/2.1.0) on [ghostwriter/case-converter](https://github.com/ghostwriter/case-converter) (1 month ago)|
...
| (TAGGED) | Release [0.11.4](https://github.com/carlosas/phpat/releases/tag/0.11.4) on [carlosas/phpat](https://github.com/carlosas/phpat) (2 months ago)|
| (TAGGED) | Release [5.0.3](https://github.com/ghostwriter/event-dispatcher/releases/tag/5.0.3) on [ghostwriter/event-dispatcher](https://github.com/ghostwriter/event-dispatcher) (2 months ago)|
...
| ⭐️ (17239) [`nikic/PHP-Parser`](https://github.com/nikic/PHP-Parser) | A PHP parser written in PHP |
| ⭐️ (1793) [`MyIntervals/PHP-CSS-Parser`](https://github.com/MyIntervals/PHP-CSS-Parser) | A Parser for CSS Files written in PHP. Allows extraction of CSS files into a data structure, manipulation of said structure and output as (optimized) CSS |
...
| ⭐️ (1168) [`carlosas/phpat`](https://github.com/carlosas/phpat) | ✔️ PHP Architecture Tester - Easy architecture testing for PHP  |
