...
- [laminas/laminas-servicemanager-migration](https://github.com/laminas/laminas-servicemanager-migration) ([0.8.0](https://github.com/laminas/laminas-servicemanager-migration/releases/tag/0.8.0), today) - Migrate your code to laminas-servicemanager 4.x compatibility utilizing Rector rules.
