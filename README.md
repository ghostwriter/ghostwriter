...
| State | Description |
| --- | --- |
| (TAGGED) | Release [v2.8.1](https://github.com/laravel-shift/blueprint/releases/tag/v2.8.1) on [laravel-shift/blueprint](https://github.com/laravel-shift/blueprint) (6 days ago)|
...
| ⭐️ (1503) [`php-fig/http-client`](https://github.com/php-fig/http-client) |  |
| ⭐️ (1626) [`php-fig/http-factory`](https://github.com/php-fig/http-factory) | Implementation of PSR-17 (HTTP Message Factories) |
...
| ⭐️ (2567) [`laravel-shift/blueprint`](https://github.com/laravel-shift/blueprint) | A code generation tool for Laravel developers. |
