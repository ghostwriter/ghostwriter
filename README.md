...
- [Bump `symplify/easy-coding-standard` to `^11.0.3`](https://github.com/ghostwriter/option/pull/3) on [ghostwriter/option](https://github.com/ghostwriter/option) (today)
- [Bump `roave/infection-static-analysis-plugin` to `^1.20.0`](https://github.com/ghostwriter/option/pull/2) on [ghostwriter/option](https://github.com/ghostwriter/option) (today)
