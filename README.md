...
| State | Description |
| --- | --- |
| (TAGGED) | Release [v8.8.0](https://github.com/MyIntervals/PHP-CSS-Parser/releases/tag/v8.8.0) on [MyIntervals/PHP-CSS-Parser](https://github.com/MyIntervals/PHP-CSS-Parser) (6 days ago)|
| (TAGGED) | Release [2.1.0](https://github.com/ghostwriter/case-converter/releases/tag/2.1.0) on [ghostwriter/case-converter](https://github.com/ghostwriter/case-converter) (1 week ago)|
| (TAGGED) | Release [5.0.1](https://github.com/ghostwriter/container/releases/tag/5.0.1) on [ghostwriter/container](https://github.com/ghostwriter/container) (1 week ago)|
| (TAGGED) | Release [1.0.3](https://github.com/ghostwriter/uuid/releases/tag/1.0.3) on [ghostwriter/uuid](https://github.com/ghostwriter/uuid) (1 week ago)|
...
| ⭐️ (10676) [`mockery/mockery`](https://github.com/mockery/mockery) | Mockery is a simple yet flexible PHP mock object framework for use in unit testing with PHPUnit, PHPSpec or any other testing framework. Its core goal is to offer a test double framework with a succinct API capable of clearly defining all possible object operations and interactions using a human readable Domain Specific Language (DSL). |
| ⭐️ (114) [`rectorphp/rector-src`](https://github.com/rectorphp/rector-src) | Development repository for Rector |
| ⭐️ (17201) [`nikic/PHP-Parser`](https://github.com/nikic/PHP-Parser) | A PHP parser written in PHP |
...
| ⭐️ (1784) [`MyIntervals/PHP-CSS-Parser`](https://github.com/MyIntervals/PHP-CSS-Parser) | A Parser for CSS Files written in PHP. Allows extraction of CSS files into a data structure, manipulation of said structure and output as (optimized) CSS |
| ⭐️ (1152) [`carlosas/phpat`](https://github.com/carlosas/phpat) | ✔️ PHP Architecture Tester - Easy architecture testing for PHP  |
