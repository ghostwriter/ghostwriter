...
| State | Description |
| --- | --- |
| (TAGGED) | Release [v8.9.0](https://github.com/MyIntervals/PHP-CSS-Parser/releases/tag/v8.9.0) on [MyIntervals/PHP-CSS-Parser](https://github.com/MyIntervals/PHP-CSS-Parser) (1 day ago)|
...
| (TAGGED) | Release [2.1.0](https://github.com/ghostwriter/case-converter/releases/tag/2.1.0) on [ghostwriter/case-converter](https://github.com/ghostwriter/case-converter) (3 months ago)|
| (TAGGED) | Release [5.0.1](https://github.com/ghostwriter/container/releases/tag/5.0.1) on [ghostwriter/container](https://github.com/ghostwriter/container) (3 months ago)|
| (TAGGED) | Release [1.0.3](https://github.com/ghostwriter/uuid/releases/tag/1.0.3) on [ghostwriter/uuid](https://github.com/ghostwriter/uuid) (3 months ago)|
...
| ⭐️ (0) [`ghostwriter/config`](https://github.com/ghostwriter/config) | Provides a Configuration object that maps configuration keys to values using dot-notation for PHP |
...
| ⭐️ (0) [`ghostwriter/configuration`](https://github.com/ghostwriter/configuration) | PHP library for managing configuration with dot-separated keys. |
...
| ⭐️ (0) [`nix-php/nixify`](https://github.com/nix-php/nixify) | PHP tool to auto-update flake inputs from GitHub tags/branches. |
| ⭐️ (0) [`nix-php/template`](https://github.com/nix-php/template) | Nix flake exposing the `template` PHP CLI application. |
