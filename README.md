...
| State | Description |
| --- | --- |
| (OPEN) | [Prevent `shouldNotReceive` from getting overridden by invocation count methods](https://github.com/mockery/mockery/pull/1329) on [mockery/mockery](https://github.com/mockery/mockery) (today)|
...
| ⭐️ (1578) [`php-fig/http-factory`](https://github.com/php-fig/http-factory) | Implementation of PSR-17 (HTTP Message Factories) |
...
| ⭐️ (1458) [`php-fig/http-client`](https://github.com/php-fig/http-client) |  |
