...
| State | Description |
| --- | --- |
| (TAGGED) | Release [1.6.7](https://github.com/mockery/mockery/releases/tag/1.6.7) on [mockery/mockery](https://github.com/mockery/mockery) (2 days ago)|
| (TAGGED) | Release [2.0.0](https://github.com/ghostwriter/json/releases/tag/2.0.0) on [ghostwriter/json](https://github.com/ghostwriter/json) (3 days ago)|
| (TAGGED) | Release [v2.9.0](https://github.com/laravel-shift/blueprint/releases/tag/v2.9.0) on [laravel-shift/blueprint](https://github.com/laravel-shift/blueprint) (4 days ago)|
