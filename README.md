...
- [nette/php-generator](https://github.com/nette/php-generator) ([v3.6.0-RC](https://github.com/nette/php-generator/releases/tag/v3.6.0-RC), 6 days ago) - 🐘 Generates neat PHP code for you. Supports new PHP 8.1 features.
- [orchestral/testbench-core](https://github.com/orchestral/testbench-core) ([v6.24.1](https://github.com/orchestral/testbench-core/releases/tag/v6.24.1), 6 days ago) - Testing Helper for Laravel Development
